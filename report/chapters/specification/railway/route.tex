	...
	Esso fornisce inoltre le procedure necessarie alla conversione da \ttt{JSON} a oggetto \ttt{Route\_Type} e viceversa. Tutti gli oggetti Route sono mantenuti in un array nel package \ttt{Routes}.
