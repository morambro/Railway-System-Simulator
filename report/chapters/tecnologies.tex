...
Il protocollo usato tra le varie componenti del sistema per lo scambio di messaggi, è quello fornito da \ii{Yami4}, e quindi lo scambio di dati in formato stringa chiave-valore; inoltre per l'invio di strutture dati complesse come Descrittori di Treni o Passeggeri, e Biglietti, ho utilizzo lo standard \ii{JSON}. Per la codifica e decodifica di stringhe \ii{JSON} mi sono servito di due librerie:
	\begin{itemize}
