...
echo "done"
	...
	Per poter avere una rappresentazione grafica degli eventi generati dalla simulazione, è sufficiente aprire in una finestra del browser \ii{Chrome} la pagina all'indirizzo \ttt{http://localhost:9000}.
