...
\chapter{Istruzioni}
	...
	L'avvio del sistema si effettua eseguendo i seguenti script presenti nella cartella principale:
		...
		\end{itemize}
	Viene fornita una configurazione di base composta da 3 Regioni; tuttavia è possibile utilizzare configurazioni diverse, modificando opportunamente i file \ttt{JSON} presenti nella cartella \ttt{railway/res}. Vengono fornite le seguenti regole:
	\begin{itemize}
