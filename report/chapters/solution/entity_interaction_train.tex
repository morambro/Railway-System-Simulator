...
% ############################################################################################################		
	...
	\begin{itemize}
		...
		\item Presso la regione $R2$, stazione di Gateway $G2$, vengono eseguite le seguenti operazioni:
			...
			\end{itemize}
		\item Una volta ricevuto il messaggio di \ii{acknowledgement}, presso il nodo $R1$ vengono eseguite le seguenti operazioni:
			\begin{itemize}
				...
				\item Viene liberata la piattaforma corrente (\ttt{Free} viene impostato a \ttt{True}).
			\end {itemize}
	\end{itemize}
