...
% #################################################################################################################	
	...
	Il Controller Centrale sarà anche responsabile dell'invio di un \ii{segnale di terminazione}, che verrà recapitato a tutti i nodi che compongono la simulazione, mediante la procedura descritta in sezione \ref{sec:distributed_termination}.
\newpage
