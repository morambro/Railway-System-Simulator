...
procedure Parameters_Test is
   ...
   procedure Test_9 is
      ...
      Is_Locked : Boolean;
      Value : YAMI.Parameters.YAMI_Integer;
      Key : YAMI.Parameters.YAMI_Long_Long_Integer := 1234567890;
      use type YAMI.Parameters.YAMI_Integer;
      use type YAMI.Parameters.YAMI_Long_Long_Integer;
   begin
      Params.Set_Integer ("name", 123);
      ...
      begin
         ...
         declare
            Nested_2 : YAMI.Parameters.Parameters_Collection :=
              Params.Create_Nested_Parameters ("more nested");
         begin
            Nested_2.Set_Integer ("more internal", 987);

            --  lock something within the hierarchy

            declare
               Other_Key : YAMI.Parameters.YAMI_Long_Long_Integer :=
                 987654321;
            begin
               ...
               begin
                  --  cannot modify
                  Nested_2.Set_Integer ("more internal", 123);
                  pragma Assert (False);
               exception
                  when E : YAMI.Logic_Error =>
               ...
               exception
                  when E : YAMI.Runtime_Error =>
                     ...
                     pragma Assert
                       (Ada.Exceptions.Exception_Message (E) =
                          "The value that was given or received " &
                          "is incorrect.");
                     null;
               end;
