...
public final class NetworkUtils {
    ...
    private static TcpListener prepareTcpServer(String target,
        ...
        if (hostName.equals("*")) {
            ...
            boundHostName = InetAddress.getLocalHost().getHostName();
        } else {
        ...
        String resolvedTarget = formatTcpTarget(boundHostName, boundPort);
    ...
    private static UdpListener prepareUdpServer(String target,
        ...
        String resolvedTarget = formatUdpTarget(boundHostName, boundPort);
