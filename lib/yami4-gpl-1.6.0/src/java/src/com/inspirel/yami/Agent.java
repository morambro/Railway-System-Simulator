...
public final class Agent {
    ...
    public OutgoingMessage send(String target,
        ...
        return doSend(target, objectName, messageName, content,
                0, true, false);
    }
    ...
    public OutgoingMessage send(String target,
        ...
        return doSend(target, objectName, messageName,
    ...
    public void sendOneWay(String target,
            String objectName, String messageName,
            YAMISerializable content) throws YAMIIOException {
        doSend(target, objectName, messageName, content, 0, true, true);
    }
    ...
    public void sendOneWay(String target,
        ...
        doSend(target, objectName, messageName, content,
                priority, true, true);
    }
    ...
    private OutgoingMessage doSend(String target,
            String objectName, String messageName,
        ...
        if (isTargetFailover(target)) {
            ...
            for (String t : targets) {
                try {
                    message = doSendToSingleTarget(t,
            ...
            message = doSendToSingleTarget(target,
                    objectName, messageName,
                    content, priority, autoConnect, oneWay,
                    waitForTransmission,
                    waitForReplyOrReject);
    ...
    private OutgoingMessage doSendToSingleTarget(String target,
            String objectName, String messageName,
            YAMISerializable content, int priority, boolean autoConnect,
            boolean oneWay,
        ...
        if (oneWay == false ||
            ...
            message = new OutgoingMessage(messageId,
