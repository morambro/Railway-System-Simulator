...
\section{Analisi del Problema}\label{analisis}
	...
	\newframe{\nameref{analisis}}{Distribuzione}{}{1}{
		...
		\myitemize {
			...
			\cm{0.2}
			\item Valutazione di come scelte di distribuzione possano influire sul realismo della simulazione. 
			\cm{0.2}
...
\section{Costruzione di una soluzione}\label{sol}
	...
	\newframe{\nameref{sol}}{Distribuzione}{}{1}{
		\myitemize {
			\item \`E importante identificare per prima cosa le componenti da distribuire e i protocolli di interazione tra di esse. 
			\item Le scelte di distribuzione influenzano\\
				\myitemize {
					\item la rappresentazione delle entità;\\
	...
	\newframe{\nameref{sol}}{Distribuzione}{}{2}{
		...
		\myitemize {
			...
			\cm{0.2}
			\item Opportuno valutare possibili architetture di distribuzione di alto livello che modellano il problema
				\cm{0.2}
				\myitemize {
					...
					\item Analisi delle implicazioni sul sistema conseguenti all'adozione di gradi di distribuzione diversi.
	...
	\newframe{\nameref{sol}}{Distribuzione}{}{3} {
		...
		\myitemize {
			...
			\item Definizione del protocollo di distribuzione che realizza l'interazione tra le componenti, in base all'architettura e ai requisiti del problema.
		}
	}
	...
	\newframe{\nameref{sol}}{Distribuzione}{Valutazione}{}{
		\myitemize {
			...
			\item ad es. La soluzione che ho adottato ha le seguenti caratteristiche:
				\myitemize {
