...
\section{Costruzione di una soluzione}\label{sol}
	...
	\newframe{\nameref{sol}}{Distribuzione}{}{2} {
		\myitemize {
			\item Scelta di una possibile architettura
		...
		\myitemize {
			...
			\item Come si traduce il trasferimento remoto di una entità?
				\myitemize {
					...
					\item replicazione?
					\item \ii{possibile soluzione:} Disaccoppiamento tra entità e thread che ne esegue le operazioni: utilizzo di un thread pool e di descrittori di entità, quest'ultimi replicati su ciascun nodo e aggiornati al trasferimento.
				}
		}
	}
	...
	\newframe{\nameref{sol}}{Concorrenza}{}{1}{
		...
		\myitemize {
			...
			\item La natura delle entità dipende dalle scelte a livello di protocollo di distribuzione.
				\myitemize {
					\item ad es. {\em Entità attive} sono gli executor appartenenti ai pool per descrittori di Treni e Viaggiatori.
				}
