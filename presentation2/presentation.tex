...
\section{Costruzione di una soluzione}\label{sol}
		...
		\myitemize {
			...
			\item Come si traduce il trasferimento remoto di una entità?
				\myitemize {
					...
					\item replicazione?
					\item Scelte di distribuzione condizionano la realizzazione delle entità per facilitare il trasferimento remoto!
	...
	\newframe{\nameref{sol}}{Distribuzione}{Valutazione}{}{
		\myitemize {
			\item Valutazione della soluzione progettata, sulla base delle caratteristiche desiderabili individuate in fase di analisi. \\
				 Ad es. nella soluzione adottata:
				\myitemize {
					\itemB{Trasparenza:}{
						La  
					}{0cm}
					\itemB{Openess:}{}{0cm}
					\itemB{Scalabilità:}{}{0cm}
					\itemB{Fault Tolerance:}{}{0cm}
				}
		}
	}
